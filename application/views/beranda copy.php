    ...
    <section class="col-lg-6">
      <div class="col-md-6">
        <div class="info-box" style="border-radius: 10px;">
         <span class="info-box-icon" style="background-color: white; border-radius: 10px; padding-top:20px; padding-left:10px;">
            <div id="perIECA" class="gauge" style="width: 70px; --rotation:0deg; --color:#5cb85c; --background:#e9ecef;">
          ...
          <div class="info-box-content">
            <span class="info-box-text">Current A</span>
            <span class="label label-success">SEL-849</span> <span class="label label-success">IEC61850</span>
            <span class="info-box-number" id="iecIA"></span>
          </div>
          <!-- /.info-box-content -->
        </div>
        <!-- /.info-box -->
      ...
      <div class="col-md-6">
        <div class="info-box" style="border-radius: 10px;">
          ...
          <div class="info-box-content">
            <span class="info-box-text">Current A</span>
            <span class="label label-success">MICOM-P123</span> <span class="label label-success">MODBUS</span>
            <span class="info-box-number" id="mdbusIA"></span>
          </div>
          <!-- /.info-box-content -->
        </div>
        <!-- /.info-box -->
      ...
      <div class="col-md-6">
        <div class="info-box" style="border-radius: 10px;">
           <span class="info-box-icon" style="background-color: white; border-radius: 10px; padding-top:20px; padding-left:10px;">
            <div id="perIECB" class="gauge" style="width: 70px; --rotation:0deg; --color:#5cb85c; --background:#e9ecef;">
              <div class="percentage"></div>
              <div class="mask"></div>
              <span class="value"></span>
            </div>
          ...
          <div class="info-box-content">
            <span class="info-box-text">Current B</span>
            <span class="label label-success">SEL-849</span> <span class="label label-success">IEC61850</span>
            <span class="info-box-number" id="iecIB"></span>
          </div>
          <!-- /.info-box-content -->
        </div>
        <!-- /.info-box -->
      ...
      <div class="col-md-6">
        <div class="info-box" style="border-radius: 10px;">
            <span class="info-box-icon" style="background-color: white; border-radius: 10px; padding-top:20px; padding-left:10px;">
            <div id="perMDCB" class="gauge" style="width: 70px; --rotation:0deg; --color:#5cb85c; --background:#e9ecef;">
              <div class="percentage"></div>
              <div class="mask"></div>
              <span class="value"></span>
            </div>
          ...
          <div class="info-box-content">
            <span class="info-box-text">Current B</span>
            <span class="label label-success">MICOM-P123</span> <span class="label label-success">MODBUS</span>
            <span class="info-box-number" id="mdbusIB"></span>
          </div>
          <!-- /.info-box-content -->
        </div>
        <!-- /.info-box -->
      ...
      <div class="col-md-6">
        <div class="info-box" style="border-radius: 10px;">
           <span class="info-box-icon" style="background-color: white; border-radius: 10px; padding-top:20px; padding-left:10px;">
            <div id="perIECC" class="gauge" style="width: 70px; --rotation:0deg; --color:#5cb85c; --background:#e9ecef;">
              <div class="percentage"></div>
              <div class="mask"></div>
              <span class="value"></span>
            </div>
          ...
          <div class="info-box-content">
            <span class="info-box-text">Current C</span>
            <span class="label label-success">SEL-849</span> <span class="label label-success">IEC61850</span>
            <span class="info-box-number" id="iecIC"></span>
          </div>
          <!-- /.info-box-content -->
        </div>
        <!-- /.info-box -->
      ...
      <div class="col-md-6">
        <div class="info-box" style="border-radius: 10px;">
            <span class="info-box-icon" style="background-color: white; border-radius: 10px; padding-top:20px; padding-left:10px;">
            <div id="perMDCC" class="gauge" style="width: 70px; --rotation:0deg; --color:#5cb85c; --background:#e9ecef;">
              <div class="percentage"></div>
              <div class="mask"></div>
              <span class="value"></span>
            </div>
          ...
          <div class="info-box-content">
            <span class="info-box-text">Current C</span>
            <span class="label label-success">MICOM-P123</span> <span class="label label-success">MODBUS</span>
            <span class="info-box-number" id="mdbusIC"></span>
          </div>
          <!-- /.info-box-content -->
        </div>
        <!-- /.info-box -->
      ...
      <div class="col-md-6">
        <div class="info-box" style="border-radius: 10px;">
           <span class="info-box-icon" style="background-color: white; border-radius: 10px; padding-top:20px; padding-left:10px;">
            <div id="perIECN" class="gauge" style="width: 70px; --rotation:0deg; --color:#5cb85c; --background:#e9ecef;">
              <div class="percentage"></div>
              <div class="mask"></div>
              <span class="value"></span>
            </div>
          ...
          <div class="info-box-content">
            <span class="info-box-text">Current N</span>
            <span class="label label-success">SEL-849</span> <span class="label label-success">IEC61850</span>
            <span class="info-box-number" id="iecIN"></span>
          </div>
          <!-- /.info-box-content -->
        </div>
        <!-- /.info-box -->
      ...
      <div class="col-md-6">
        <div class="info-box" style="border-radius: 10px;">
          <span class="info-box-icon" style="background-color: white; border-radius: 10px; padding-top:20px; padding-left:10px;">
            <div id="perMDCN" class="gauge" style="width: 70px; --rotation:0deg; --color:#5cb85c; --background:#e9ecef;">
              <div class="percentage"></div>
              <div class="mask"></div>
              <span class="value"></span>
            </div>
          ...
          <div class="info-box-content">
            <span class="info-box-text">Current N</span>
            <span class="label label-success">MICOM-P123</span> <span class="label label-success">MODBUS</span>
            <span class="info-box-number" id="mdbusIN"></span>
          </div>
          <!-- /.info-box-content -->
        </div>
        <!-- /.info-box -->
