...
class Com_data extends CI_Controller
{
    // Konstruktor
	function __construct()
    {
		...
		$this->load->model('Com_model'); //memanggil config model  cuyy
   ...
   public function index(){
	...
	$row['data']=$this->Com_model->get_all();

	$this->load->view('header',$dataAdm);	 // Menampilkan bagian header dan object data users
	$this->load->view('data/data_com',$row); // Menampilkan config com
